...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/DAc8t9kfAyEIKS1KmyFrth?mode=ems_copy_t',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/069me0.png',
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '💴 𝐂𝙾𝙽𝙽𝙴𝙲𝚃  ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙 ',
        '📞 Number: ${number}\n🩵 Status: Connected',
        '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙'
    );
...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝑆𝐻ҨᏩ𝛯𝛯 𝛭𝐷';
const footerText = '> ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙';

const buttonMessage = {
    image: { url: "https://files.catbox.moe/069me0.png" },
    caption: captionText,
    footer: footerText,
    buttons,
    headerType: 1
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/069me0.png" },
        caption: `𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐷 𝛭𝐼𝚴𝐼 𝛣𝛩亇 𝜟𝐿𝐼𝛶𝛯 𝚴𝛩ꪝ..!\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
...
`;
    ...
    await socket.sendMessage(from, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: `✨ *Welcome to 𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐷 MINI BOT* ✨\n\n${menuText}\n\n> 🚀 Powered by 𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐷`
    });
    ...
    try {
        ...
        if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_SEEN) {
            ...
            if (config.AUTO_STATUS_REPLY) {
                const customMessage = config.STATUS_READ_MSG || '*✅ 𝜟び亇𝛩 𝑆亇𝜟亇び𝑆 𝑆𝛯𝛯𝚴 𝛣𝑌 𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼*';
...
case 'shagee': {
    try {
        ...
        let txt = `*👑 𝐒ʜᴀɢᴇᴇ 𝐌ᴅ DEPLOYERS LIST*\n\n`;
        let count = 1;
        ...
        console.error("❌ SHAGEE 𝐗 𝐌𝐃 plugin error:", err);
        ...
        for (let num of owners) {
            try {
                await socket.sendMessage(num + "@s.whatsapp.net", { 
                    text: `📢 * Broadcast*\n\n${msgText}\n\n> Sent via ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙 🚀`
                });
                successCount++;
            } catch (e) {
                ...
                case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363421350428668@newsletter'
                        });
                    }
  ...
  break;
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "𝑆𝐻𝜟Ꮹ𝛯𝛯 𝐹𝑅𝛯𝛯 𝛣𝛩亇" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙" },
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            video: { url: result.sd },
            mimetype: 'video/mp4',
            caption: '> ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙'
        }, { quoted: msg });
                ...
                case 'winfo':
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Invalid phone number!( 𝛯𝚴5𝛯𝑅 +94 𝜟𝐷𝐷 𝑌𝛩び𝑅 𝚴び𝛭𝛣𝛯𝑅)(e.g., +94700000000)',
                                '> ⛩️̶͟͞🔥⃝𝑆𝐻𝜟Ꮹ𝛯𝛯 𝛭𝐼𝚴𝐼 𝛣𝛩亇🕊️̶͟͞🌙'
                            )
                        });
                        break;
...
case 'ping': {
    try {
        ...
        // 🟢 Reply test message
        const sentMsg = await socket.sendMessage(from, { text: "𝛲𝐼𝚴Ꮹ𝐼𝚴Ꮹ.....🪄" });
  ...
  if (!q || q.trim() === '') {
    return await socket.sendMessage(sender, {
      text: "ඕ කියන්න අනේ් මම 𝑆𝐻𝜟Ꮹ𝛯𝛯 AI🤭"
    }, { quoted: msg });
  }

  const prompt = `ඔබගේ නම 𝑆𝐻𝜟Ꮹ𝛯𝛯 𝐀𝐈.  
